<?php 
    ...
    $text = get_field('text');
    $background_img_show = get_field('background_image');
...
<?php else: ?>
   ...
   <section class="padded-mid general-cta bg-<?php echo $background_color ? esc_html($background_color) : '' ; ?> <?php echo $background_img_show ? 'bg-image' : '' ;?>"> 
        <?php if (!empty($image) && $background_img_show === true) : ?>
